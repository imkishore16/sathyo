...
export default class Sign_up extends Component {
  ...
  handleSignUp = () => {
    const { name, email, mobile, password, confirmPassword, address, gender, performance, totalMeditation, userType,request,chat,availability } = this.state;
    ...
    createUserWithEmailAndPassword(auth, email, password)
      .then(() => {
        const formData = { name, email, mobile, address, gender, performance, totalMeditation, userType,request,chat,availability };

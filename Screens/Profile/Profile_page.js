    ...
    return (
        <ScrollView contentContainerStyle={styles.container}>
            ...
            <View style={styles.detailsContainer}>
                ...
                <Text style={styles.detailLabel}>Dhiyanam:</Text>
                <Text style={styles.detailValue}>{userData.totalMeditation}</Text>

                <Text style={styles.detailLabel}>Thirayadhiyanam:</Text>
                <Text style={styles.detailValue}>{userData.tri}</Text>

                <Text style={styles.detailLabel}>Jabam:</Text>
                <Text style={styles.detailValue}>{userData.performance}</Text>
            </View>
        </ScrollView>
    );
